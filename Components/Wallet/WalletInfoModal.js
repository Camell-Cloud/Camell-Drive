...
import AddWalletAddressModal from '../../Components/Wallet/AddPersonalWalletAddress'
...
const fetchWalletAddress = async () => {
  try {
    ...
    if (data.success && data.wallet_address) {
      setWalletAddress(data.wallet_address); // 개인 지갑 주소 상태에 저장
    } else {
  ...
  return (
    ...
    >
      <View style={styles.modalView}>
        ...
        <View style={styles.ContaonersContainer}>

          <View style={styles.MainContainer}>

            <View style={styles.contentContainer}>
                <Text style={styles.contentTitle}>Username</Text>
                <Pressable onPress={() => copyToClipboard(username)} style={styles.contentValueContainer}>
            ...
            <View style={styles.contentContainer}>
              ...
              <Pressable onPress={() => copyToClipboard(privateKey)} style={styles.contentValueContainer}>
            ...
            <View style={styles.contentContainer}>
              ...
              <View style={styles.contentValueContainer}>
                <Text style={styles.contentValue}>TRC-20</Text>
              </View>
            </View>
            ...
            <View style={styles.contentContainer}>
              ...
              {walletAddress ? (
              <View>
                <Pressable onPress={() => copyToClipboard(walletAddress)} style={styles.contentValueContainer}>
                  <Text style={styles.contentValue}>{walletAddress}</Text>
                </Pressable>
                <Pressable style={styles.deleteButton} onPress={deleteWalletAddress}>
                  <Text style={styles.deleteButtonText}>Delete Wallet Address</Text>
                </Pressable>
              </View>
            ) : (
              <Pressable style={styles.addButton} onPress={() => setIsAddAddressModalVisible(true)}>
